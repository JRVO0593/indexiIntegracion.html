...
<ul>
	...
	<li><a href="/system/modules/com.tfsla.diario.telesur/templates/indexIntegracion.jsp" class="active" >HOME</a></li>
	<li><a href="/system/modules/com.tfsla.diario.telesur/templates/about_integracion.jsp" class="active" >NOTICIAS</a></li>
	<li class="dropdown">
	<a href="#" class="dropdown-toggle" data-toggle="dropdown">MAS PAGINAS<b class="caret" ></b></a>
		<ul class="dropdown-menu">
			<li><a href="/system/modules/com.tfsla.diario.telesur/templates/sidebarleft_morepages_integracion.jsp"  class="active"  >BLOGS</a></li>
			<li><a href="/system/modules/com.tfsla.diario.telesur/templates/sidebarright_morepages_integracion.jsp"  class="active"  >OPINION</a></li>
			<li><a href="/system/modules/com.tfsla.diario.telesur/templates/single_morepages_integracion.jsp"  class="active"  >SOY REPORTERO</a></li>
		</ul>
	</li>
	<li><a href="/system/modules/com.tfsla.diario.telesur/templates/blog_integracion.jsp" class="active" >VIDEOS</a></li>
</ul>
-->
		...
		<div class="container-fluid">
			...
			<div class="navbar-collapse collapse">
				...
				<ul class="nav navbar-nav">
					...
					<li><a href="/system/modules/com.tfsla.diario.telesur/templates/about_integracion.jsp">NOTICIAS</a></li>
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">MAS PAGINAS<b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="sidebarleft_morepages_integracion.jsp">BLOGS</a></li>
							<li><a href="sidebarright_morepages_integracion.jsp">OPINION</a></li>
							<li><a href="single_morepages_integracion.jsp">SOY REPORTERO</a></li>
						</ul>
					</li>
					<li><a href="/system/modules/com.tfsla.diario.telesur/templates/blog_integracion.jsp">VIDEOS</a></li>
				</ul>
