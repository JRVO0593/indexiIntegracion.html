        ...
        <%--
            <div class="nav">
                ...
                <ul class="menu">
                    ...
                    <li id="btn-face" class="activeComent">
                        <a id="btn-cf" href="#.">
                    ...
                    <li id="btn-nativo" class="activeComent">
                        <a id="btn-cn" href="#.">
    ...
    <div class="comentArtic">
        <div id="comentFace">
            <div class="wrapper">
                ...
                <div class="row clear"> 
                    <div class="fb-comments" data-href="http://www.telesurtv.net<nt:link/>" data-width="690" data-numposts="5" data-colorscheme="light"></div>             
                </div>
                </nt:news>
            </div>
        </div>
                                    ...
                                    <div class="cont">
                                        <div class="comsup">
                                            <div class="titcomment">
                                                <div class="titlecom" id="comentarios">Comentarios de Telesur</div>
                                                <div class="gblogrs">
