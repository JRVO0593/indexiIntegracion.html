...
<head>
	...
	<link href="/arte/imagenes_integracion/gt_favicon.png" rel="shortcut icon" />
...
<header id="header">
	<div id="head" class="parallax" parallax-speed="1">
		<h1 id="logo" class="text-center">
			<img class="img-circle" src="/arte/imagenes_integracion/guy.jpg" alt="">
		...
		<div class="container-fluid">
			...
			<div class="navbar-collapse collapse">
				...
				<ul class="nav navbar-nav">
					<li><a href="indexIntegracion.jsp">Home</a></li>
					<li><a href="about_integracion.jsp">About</a></li>
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">More Pages <b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="sidebarleft_morepages_integracion.jsp">Left Sidebar</a></li>
							<li><a href="sidebarright_morepages_integracion.jsp">Right Sidebar</a></li>
							<li><a href="single_morepages_integracion.jsp">Blog Post</a></li>
						</ul>
					</li>
					<li class="active"><a href="blog_integracion.jsp">Blog</a></li>
				</ul>
			...
			<div class="col-sm-8 col-sm-offset-2">
				...
				<article class="post">
					<header class="entry-header">
						...
						<h1 class="entry-title"><a href="single_morepages_integracion.jsp" rel="bookmark">Hello world!</a></h1>
					</header>
				...
				<article class="post">
					<header class="entry-header"> 
						...
						<h1 class="entry-title"><a href="single_morepages_integracion.jsp" rel="bookmark">Maecenas Quisque Suspendisse Lorem</a></h1>
					</header>
					<div class="entry-content">
						<p>Mauris eget quam orci. Quisque porta varius dui, quis posuere nibh mollis quis. Mauris commodo rhoncus porttitor. Maecenas et euismod elit. Nulla facilisi. Vivamus lacus libero, ultrices non ullamcorper ac, tempus sit amet enim. Suspendisse at semper ipsum. Suspendisse sagittis diam a massa viverra sollicitudin. Vivamus sagittis est eu diam fringilla nec tristique metus vestibulum. Donec magna purus, pellentesque vel lobortis ut, convallis id augue. Sed odio magna, pellentesque eget convallis ac, vehicula vel arcu. Sed eu scelerisque dui. Sed eu arcu at nibh hendrerit viverra. Vivamus lacus augue, sodales id cursus in, condimentum at risus. <a href="single_morepages_integracion.jsp" class="more-link">Continue reading…</a></p>
					</div>
				...
				<article class="post">
					<header class="entry-header">
						...
						<h1 class="entry-title"><a href="single_morepages_integracion.jsp" rel="bookmark">Pellentesque Eget Convallis</a></h1>
					</header>
					<div class="entry-content">
						<p>Mauris eget quam orci. Quisque porta varius dui, quis posuere nibh mollis quis. Mauris commodo rhoncus porttitor. Maecenas et euismod elit. Nulla facilisi. Vivamus lacus libero, ultrices non ullamcorper ac, tempus sit amet enim. Suspendisse at semper ipsum. Suspendisse sagittis diam a massa viverra sollicitudin. Vivamus sagittis est eu diam fringilla nec tristique metus vestibulum. Donec magna purus, pellentesque vel lobortis ut, convallis id augue. Sed odio magna, pellentesque eget convallis ac, vehicula vel arcu. Sed eu scelerisque dui. Sed eu arcu at nibh hendrerit viverra. Vivamus lacus augue, sodales id cursus in, condimentum at risus. <a href="single_morepages_integracion.jsp" class="more-link">Continue reading…</a></p>
					</div>
...
<script src="system/modules/com.tfsla.diario.telesur/js/template_jquery_integracion.js"></script>
</body>
</html>
