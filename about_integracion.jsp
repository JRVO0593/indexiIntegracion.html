...
<head>
	...
	<!--[if lt IE 9]> <script src="system/modules/com.tfsla.diario.telesur/resources/js/html5shiv.js"></script> <![endif]-->
</head>
<body>
		...
		<div class="container-fluid">
			...
			<div class="navbar-collapse collapse">
				...
				<ul class="nav navbar-nav">
					<li><a href="/system/modules/com.tfsla.diario.telesur/templates/indexIntegracion.jsp">Home</a></li>
					<li class="active"><a href="about_integracion.jsp">About</a></li>
					<li class="dropdown">
					...
					<li><a href="blog_integracion.jsp">Blog</a></li>
				</ul>
...
<main id="main">
	...
	<div class="container">
		...
		<div class="row topspace">
			...
			<!-- Sidebar -->
			<aside class="col-sm-4 sidebar sidebarright_morepages_integracion.jsp">
			...
			<article class="col-sm-8 maincontent">
				...
				<p><img src="/arte/imagenes_integracion/mac.jpg" alt="" class="" width="100%" ></p>
